...
public final class AuthorizationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ru.vtb.s7.client.mkb.grpc.AuthorizationRequest,
      ru.vtb.s7.client.mkb.grpc.AuthorizationReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = ru.vtb.s7.client.mkb.grpc.AuthorizationRequest.class,
      responseType = ru.vtb.s7.client.mkb.grpc.AuthorizationReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ru.vtb.s7.client.mkb.grpc.AuthorizationRequest,
      ru.vtb.s7.client.mkb.grpc.AuthorizationReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<ru.vtb.s7.client.mkb.grpc.AuthorizationRequest, ru.vtb.s7.client.mkb.grpc.AuthorizationReply> getSayHelloMethod;
      ...
      synchronized (AuthorizationGrpc.class) {
        if ((getSayHelloMethod = AuthorizationGrpc.getSayHelloMethod) == null) {
          AuthorizationGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<ru.vtb.s7.client.mkb.grpc.AuthorizationRequest, ru.vtb.s7.client.mkb.grpc.AuthorizationReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.vtb.s7.client.mkb.grpc.AuthorizationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.vtb.s7.client.mkb.grpc.AuthorizationReply.getDefaultInstance()))
  ...
  public static abstract class AuthorizationImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(ru.vtb.s7.client.mkb.grpc.AuthorizationRequest request,
        io.grpc.stub.StreamObserver<ru.vtb.s7.client.mkb.grpc.AuthorizationReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ru.vtb.s7.client.mkb.grpc.AuthorizationRequest,
                ru.vtb.s7.client.mkb.grpc.AuthorizationReply>(
  ...
  public static final class AuthorizationBlockingStub extends io.grpc.stub.AbstractBlockingStub<AuthorizationBlockingStub> {
    ...
    /**
     */
    public ru.vtb.s7.client.mkb.grpc.AuthorizationReply sayHello(ru.vtb.s7.client.mkb.grpc.AuthorizationRequest request) {
  ...
  public static final class AuthorizationFutureStub extends io.grpc.stub.AbstractFutureStub<AuthorizationFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.vtb.s7.client.mkb.grpc.AuthorizationReply> sayHello(
        ru.vtb.s7.client.mkb.grpc.AuthorizationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((ru.vtb.s7.client.mkb.grpc.AuthorizationRequest) request,
              (io.grpc.stub.StreamObserver<ru.vtb.s7.client.mkb.grpc.AuthorizationReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class AuthorizationBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.vtb.s7.client.mkb.grpc.AuthorizationService.getDescriptor();
    }
